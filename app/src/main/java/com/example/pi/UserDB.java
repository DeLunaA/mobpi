...
public class UserDB {
    ...
    private static final String NOM_BDD = "Pi.db";
    ...
    public int getUserWithTelephone(String tel ){
        ...
        Cursor c = bdd.query(TABLE_USER, new String[] {COL_Nom, COL_Prenom, COL_Tel, COL_Email, COL_Mdp}, COL_Tel
                + " LIKE \"" + tel +"\"", null, null, null, null);
